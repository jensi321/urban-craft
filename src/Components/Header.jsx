            ...
            <header className="flex justify-center self-stretch border-b border-solid border-gray-200_01 bg-white-a700 py-3">
                <nav aria-label="Global" className="mx-auto flex w-full max-w-6xl items-center justify-between gap-5 flex-row  xl:px-0 px-5">
                    ...
                    <PopoverGroup className="hidden lg:flex lg:gap-x-12">
                        ...
                        <Link>
                            <p className=' text-[14px] font-medium text-black-900'>Home</p>
                        </Link>

                        <Popover className="relative">
                            <PopoverButton className="flex items-center gap-x-1 focus:outline-none">
                                <p className=' flex flex-row items-center text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900 '>Shop <span className='pl-[3px]'><IoIosArrowDown /> </span></p>
                            </PopoverButton>

                            <PopoverPanel
                                transition
                                className="absolute -left-8 top-full p-[20px] z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg border border-solid border-gray-200_01 transition data-[closed]:translate-y-1 data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in"
                            >
                                <div className="flex justify-between">
                                    <div className="gap-[12px] flex flex-col">
                                        <h6 className='text-[20px] font-[700] '>Item 1</h6>
                                        <div className="gap-[6px] flex flex-col">
                                            <Link>
                                                <p className=' text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900'>link1</p>
                                            </Link>
                                            <Link>
                                                <p className=' text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900'>link1</p>
                                            </Link>
                                    ...
                                    <div className="gap-[12px] flex flex-col">
                                        <h6 className='text-[20px] font-[700] '>Item 2</h6>
                                        <div className="gap-[6px] flex flex-col">
                                            <Link>
                                                <p className=' text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900'>link2</p>
                                            </Link>
                                            <Link>
                                                <p className=' text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900'>link2</p>
                                            </Link>
                                    ...
                                    <div className="gap-[12px] flex flex-col">
                                        <h6 className='text-[20px] font-[700] '>Item 3</h6>
                                        <div className="gap-[6px] flex flex-col">
                                            <Link>
                                                <p className=' text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900'>link3</p>
                                            </Link>
                                            <Link>
                                                <p className=' text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900'>link3</p>
                                            </Link>
                        ...
                        <Link>
                            <p className=' text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900'>Offers</p>
                        </Link>
                        <Link>
                            <p className='  text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900'>Contact us</p>
                        </Link>
                        <Link>
                            <p className='  text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900'>Blog</p>
                        </Link>
                        ...
                        <div className="mt-6 flow-root">
                            <div className="-my-6 ">
                                <div className="space-y-2 py-6 gap-[10px] flex flex-col">
                                    <Link>
                                        <p className=' text-[14px] font-medium text-black-900 px-[20px]'>Home</p>
                                    </Link>
                                    <Disclosure as="div" className="">
                                        <DisclosureButton className="text-[14px] w-full text-left cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900 px-[20px]">
                                            Shop
                                        </DisclosureButton>
                                        <DisclosurePanel className="mt-2 space-y-2">
                                            <div className="flex flex-col justify-between]">
                                                <div className="gap-[12px] flex flex-col mb-[10px] p-[20px] border-b border-solid border-gray-200_01">
                                                    <h6 className='text-[16px] font-[700] '>Item 1</h6>
                                                    <div className="gap-[6px] flex flex-col">
                                                        <Link>
                                                            <p className=' text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900'>link1</p>
                                                        </Link>
                                                ...
                                                <div className="gap-[12px] flex flex-col mb-[10px] p-[20px] border-b border-solid border-gray-200_01">
                                                    <h6 className='text-[16px] font-[700] '>Item 2</h6>
                                                    <div className="gap-[6px] flex flex-col">
                                                        <Link>
                                                            <p className=' text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900'>link2</p>
                                                        </Link>
                                                ...
                                                <div className="gap-[12px] flex flex-col mb-[10px] p-[20px] border-b border-solid border-gray-200_01">
                                                    <h6 className='text-[16px] font-[700] '>Item 3</h6>
                                                    <div className="gap-[6px] flex flex-col">
                                                        <Link>
                                                            <p className=' text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900'>link3</p>
                                                        </Link>
                                    ...
                                    <Link>
                                        <p className=' text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900 px-[20px]'>Offers</p>
                                    </Link>
                                    <Link>
                                        <p className='  text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900 px-[20px]'>Contact us</p>
                                    </Link>
                                    <Link>
                                        <p className='  text-[14px] cursor-pointer font-normal text-gray-600_01 hover:font-medium hover:text-black-900 px-[20px]'>Blog</p>
                                    </Link>
                                </div>
                            </div>
                        </div>
