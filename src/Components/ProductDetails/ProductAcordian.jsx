...
const ProductAcordian = () => {
  Aos.init()
  const [activeIndex, setActiveIndex] = useState(0); // default open index
  ...
  return (
    <div className="flex-col">
      {accordionItems.map((item, index) => (
        <div className="accordion__item" key={index} data-aos="fade-up" data-aos-duration="1000">
          <div
            ...
            <div className="w-full">
              <div className="">
                <div className="flex items-center justify-between gap-5">
                  <p
                    className={`md:text-[22px] text-[24px] font-medium text-black-900 ${
                  ...
                  <button
                    className={`rounded-[12px] w-[24px] px-1.5 flex flex-row items-center justify-center text-center cursor-pointer whitespace-nowrap rounded-[50%] h-[24px] px-1.5 bg-gray-200_03 ${
                      activeIndex === index ? 'active' : ''
                    }`}
                  >
