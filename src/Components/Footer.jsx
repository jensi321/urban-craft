      ...
      <footer className='flex items-end justify-center border-t border-solid border-gray-200_01 py-5'>
        <div className="mx-auto mt-5 flex w-full max-w-6xl justify-center xl:px-0 px-5">
          <div className="flex w-full flex-col items-center gap-5">
            <div className="flex lg:items-center justify-between gap-5 self-stretch lg:flex-row flex-col">
              ...
              <div className="lg:w-[40%] flex items-start justify-between gap-5 w-full sm:flex-row flex-col">
                <div className="gap-[18px] sm:w-[36%] flex flex-col items-start w-full" data-aos="fade-up" data-aos-duration="1000">
                  ...
                  <ul className='flex flex-col items-start gap-5'>
                    <li><Link> <p  className=' text-[16px] font-normal text-gray-600_01'>Product </p></Link></li>
                    <li><Link> <p  className=' text-[16px] font-normal text-gray-600_01'>Services </p></Link></li>
                    <li><Link> <p  className=' text-[16px] font-normal text-gray-600_01'>Article </p></Link></li>
                    <li><Link> <p  className=' text-[16px] font-normal text-gray-600_01'>About Us </p></Link></li>
                  </ul>
                </div>
                ...
                <div className="gap-[18px] sm:w-[36%] w-full flex flex-col items-start" data-aos="fade-up" data-aos-duration="1000">
                  ...
                  <ul className="flex flex-col items-start gap-5">
                    ...
                    <li><Link> <p className=' text-[16px] font-normal text-gray-600_01'>Contact us</p></Link></li>
                    <li><Link> <p className=' text-[16px] font-normal text-gray-600_01'>Privacy</p></Link></li>
                    <li><Link> <p className=' text-[16px] font-normal text-gray-600_01'>Returns policy</p></Link></li>
                  </ul>
                </div>
              </div>
              <div className="lg:w-[20%] flex flex-col items-start justify-center gap-4 md:self-start w-full self-auto" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className="flex flex-col items-start gap-4 self-stretch">
                  ...
                  <input type="email" name="" placeholder="Enter your mail" className='bg-transparent focus:outline-none'/>
                  </label>
            ...
            <p className=' text-[12px] font-normal text-gray-600_01'>© 2023 by Urban craft all rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
