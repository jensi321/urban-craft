    ...
    <>
      ...
      { !isFormOpen && (
        ...
        <div className="flex flex-col items-start gap-5" data-aos="fade-right" data-aos-duration="500">
          <p className=' md:text-[22px] text-[24px] font-medium text-black-900 undefined'>Deliver to</p>
            ...
            <div className="rounded-[16px] p-[18px] gap-[18px] md:w-[48%] flex flex-col items-center border-2 border-solid border-lime-900 w-full" data-aos="zoom-in" data-aos-duration="500">
              <div className="flex justify-between gap-5 self-stretch">
                <div className="flex flex-1 items-center gap-3">
                  <input type="radio" defaultChecked={true} name='address' className='w-[20px] h-[20px]' />
                  <p className=' text-[18px] font-medium text-black-900 undefined'>Jack Jonnas</p>
                </div>
                <div className="gap-[13px] flex items-center">
                  <p className=' text-[12px] flex items-center justify-center rounded bg-gray-200 p-0.5 font-normal text-lime-900 undefined'>Home</p>
              ...
              <div className="flex flex-col gap-2.5 self-stretch">
                <div className="flex flex-col items-start gap-1">
                  ...
                  <p className=' leading-[22px] text-[14px] w-full font-normal text-black-900 undefined'>8424 James Lane South, San Francisco, CA 94080 </p>
                </div>
                <div className="flex flex-col items-start gap-1">
                  <p className=" text-[14px] font-normal text-gray-600_01 undefined">Phone :</p>
                  <p className=' text-[14px] font-normal text-black-900 undefined'> + 380 (0564) 53 - 29 - 68</p>
                </div>
              </div>
            </div>
            <div className="rounded-[16px] p-[18px] gap-[18px] md:w-[48%] flex flex-col items-center border-2 border-solid border-lime-900 w-full" data-aos="zoom-in" data-aos-duration="500">
              <div className="flex justify-between gap-5 self-stretch">
                <div className="flex flex-1 items-center gap-3">
                  <input type="radio" name='address' className='w-[20px] h-[20px]' />
                  <p className=' text-[18px] font-medium text-black-900 undefined'>Jack Ma</p>
                </div>
                <div className="gap-[13px] flex items-center">
                  <p className=' text-[12px] flex items-center justify-center rounded bg-gray-200 p-0.5 font-normal text-lime-900 undefined'>Office</p>
                  <Link onClick={handleEditClick}> <img src="assets/Images/edit.svg" alt="" className='w-[24px] h-[24px]' /></Link>
                </div>
              </div>
              <div className="flex flex-col gap-2.5 self-stretch">
